...
:root {
        ...
        --color-base-outline-button-labels: 5, 70, 126;
        --color-base-accent-1: 104, 167, 250;
        --color-base-accent-2: 5, 70, 126;
        --payment-terms-background-color: #ffffff;

        --gradient-base-background-1: #ffffff;
        --gradient-base-background-2: #f5f5f5;
        --gradient-base-accent-1: #68a7fa;
        --gradient-base-accent-2: linear-gradient(54deg, rgba(52, 125, 228, 1) 14%, rgba(26, 88, 175, 1) 85%);
...
@media screen and (min-width:990px){
  ...
  .header--middle-center{grid-template-columns:1fr auto 1fr;align-items:center;column-gap:1.5rem;}
...
/* Logo: enlarge ratio box so HIPORA text is fully visible (not clipped) */
...
<span class="visually-hidden">Facebook</span>
        ...
        <ul class="list-menu list-menu--inline" role="list"><li><a href="/" class="header__menu-item header__menu-item--main list-menu__item link link--text focus-inset">
          ...
          ><span style="display:inline-block;font-weight:900;font-size:26px;line-height:50px;letter-spacing:2px;color:#05467E;font-family:Arial,Helvetica,sans-serif;">HIPORA</span>
