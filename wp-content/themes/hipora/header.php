    ...
    <div class="cal-header-inner">
      ...
      <div class="cal-header-left">
        ...
        <nav class="cal-nav-desktop" aria-label="Main menu">
          ...
          <a href="<?php echo esc_url( home_url( '/product/hipora-alignment-pillow/' ) ); ?>">Product</a>
        </nav>
      </div>

      <a href="<?php echo esc_url( home_url( '/' ) ); ?>" class="cal-logo" aria-label="Hipora">
        <span class="cal-logo-text">HIPORA</span>
      </a>

      <div class="cal-header-right">
        <a href="#" class="cal-icon-btn" aria-label="Search">
        ...
        <a href="<?php echo esc_url( site_url( '/my-account/' ) ); ?>" class="cal-icon-btn" aria-label="Account">
